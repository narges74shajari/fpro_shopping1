...
import 'package:http/http.dart';
import 'Product.dart';
import 'DescriptionPaoge.dart';
import 'package:shopping_app/BranchesPage.dart';
...
class _StoreState extends State<Store> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        floatingActionButton: FloatingActionButton(backgroundColor: Colors.red[900],child: Icon(Icons.add),),
 ...
 void fetchItems() async {
   var url = Uri.parse("http://95.216.69.11:3000/db.json");//http://95.216.69.11:3000/db.json
   Response response = await get(url);
   setState(() {
     var productJson = json.decode(utf8.decode(response.bodyBytes));
     for (var i in productJson) {
       var productItem = Product(
           i['product_name'], i['id'], i['price'], i['image_url'], i['off'],
           i['description']);
